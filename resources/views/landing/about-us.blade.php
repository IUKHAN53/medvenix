    ...
    <div class="container-fluid" id="content" tabindex="-1">
      <div class="video-container">
        <video autoplay loop muted style="opacity: 0.5">
          <source src="{{$settings->about_video ?? asset('landing/assets/videos/about-us-video.mp4')}}"
                  type="video/mp4">
        </video>
      ...
      <section
        ...
        <div class="elementor-container elementor-column-gap-no">
          <div
            class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-4affe781"
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
              ...
              <div
                class="elementor-element elementor-element-6a59ad98 d-h3 m-h2 elementor-widget elementor-widget-heading"
              ...
              <div class="elementor-element elementor-element-205f317b elementor-widget elementor-widget-text-editor"
                ...
                <div class="elementor-widget-container">
                  <p class="text-center">Medvenix is a company full of leaders, bringing together decades of experience
                    in
                    ...
                    <div class="hyro-section_team__item__top" style="border-radius: 20px;">
                      ...
                      <div class="hyro-section_team__item__top-hover">
                        <figure style="margin-top: 22px">
                          <img src="{{asset('landing/assets/img/favicon.png')}}" width="50px" alt="">
                        </figure>
      ...
      <section
        ...
        <div class="elementor-container elementor-column-gap-no">
          <div
            class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-eb6d1c7"
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
              ...
              <div
                class="elementor-element elementor-element-d13bdf8 d-h3 m-h2 elementor-widget elementor-widget-heading"
