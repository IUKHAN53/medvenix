...
@section('content')
        ...
        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-6da175d"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <section
              ...
              <div class="elementor-container elementor-column-gap-no">
                <div
                  class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-e95f5ba"
                  data-id="e95f5ba" data-element_type="column">
                  <div class="elementor-widget-wrap elementor-element-populated">
                    <div
                      class="elementor-element elementor-element-cd7e217 d-h3 m-h1 elementor-widget elementor-widget-heading"
                    ...
                    <div
                      class="elementor-element elementor-element-e04cc47 elementor-widget elementor-widget-text-editor"
                ...
                <div
                  class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-dea0ba0 hyro-form-wrapper hyro-form-wrapper--light"
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    <div
                      class="elementor-element elementor-element-446cc2e elementor-button-align-stretch elementor-form-style--multi_field elementor-form-color--dark elementor-form-button--pink elementor-form-button--filled elementor-widget elementor-widget-form">
                      <div class="elementor-widget-container">
                        <form class="elementor-form" method="post">
                          <div class="elementor-form-fields-wrapper elementor-labels-above">
                            <div
                              class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-firstname elementor-col-50 elementor-field-required">
                            ...
                            <div
                              class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-jobtitle elementor-col-100 elementor-field-required">
                            ...
                            <div
                              class="elementor-field-type-select elementor-field-group elementor-column elementor-field-group-how_did_you_hear_about_us_ elementor-col-100">
                            ...
                            <div
                              ...
                              <button type="button" class="btn btn-primary btn-blue btn-lg w-100" onclick="sendEmail();">
                                Let's Talk
                              </button>
                            </div>
                          </div>
  ...
  <script>
    function sendEmail() {
      ...
      const jobTitle = document.getElementById("form-field-jobtitle").value;
      const company = document.getElementById("form-field-company").value;
      const howDidYouHear = document.getElementById("form-field-how_did_you_hear_about_us_").value;

      const subject = encodeURIComponent("Demo Request from " + firstName + " " + lastName);
      ...
      window.location.href = `mailto:medvenix@info.com?subject=${subject}&body=${body}`;
    }
  </script>
@endsection
