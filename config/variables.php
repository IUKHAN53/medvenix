...
return [
  ...
  "livePreview" => "https://demos.pixinvent.com/medvenix-html-admin-template/landing/",
  ...
  "documentation" => "https://demos.pixinvent.com/medvenix-html-admin-template/documentation",
  "generator" => "",
  "changelog" => "https://demos.pixinvent.com/medvenix/changelog.html",
  "repository" => "https://github.com/pixinvent/medvenix-html-admin-template",
  "gitRepo" => "pixinvent",
  "gitRepoAccess" => "medvenix-html-admin-template",
